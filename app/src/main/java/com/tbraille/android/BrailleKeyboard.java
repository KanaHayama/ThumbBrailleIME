    ...
    public View onCreateInputView() {
        ...
        mGifButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                BrailleKeyboard.this.doCommitContent("A waving flag", MIME_TYPE_GIF, mGifFile);
            }
        });
        ...
        mPngButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BrailleKeyboard.this.doCommitContent("A droid logo", MIME_TYPE_PNG, mPngFile);
            }
        });
        ...
        mWebpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BrailleKeyboard.this.doCommitContent(
